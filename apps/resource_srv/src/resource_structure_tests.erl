-module(resource_structure_tests).
...
test_mine_resource_production() ->
    ...
    ?assertEqual(
        ...
        resource_structure:create_or_convert_resources(
            [Resource],
            TestStructure,
            ?STRUCTURE_TYPE_MINE,
            OneSecondDeltaTime)),
...
test_output_space_over_capacity() ->
    ...
    ?assertEqual(
        #resource{
            name = <<"metal">>,
            amount = 2.0},
        resource_structure:cap_output_capacity(
...
test_hourly_resource_rate() ->
    ...
    ?assertEqual(
        0.027777,
        resource_structure:hourly_resource_rate(
...
test_truncate_floating_point() ->
    ?assertEqual(
        6.6666,
        resource_structure:truncate(6.6666666666, 4)),
    ?assertEqual(
        101.34,
        resource_structure:truncate(101.34123456789, 2)).
